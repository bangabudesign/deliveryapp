<template>
    <section>
        ...
        <v-container class="bg-white" style="padding-bottom: 64px;">
            ...
            <v-card v-if="user.is_premium == 1" flat color="primary" class="rounded-lg mb-10">
                <v-card-title class="d-flex flex-column align-center justify-center text-center">
                    <div class="mb-3">
                        <small class="white--text font-weight-normal">Profit Claim Minimal Transaksi</small>
                        <div class="white--text" style="margin-top: -8px;">SALDO RP  {{ user ? numberFormat(user.total_balance) : 0 }}</div>
                    </div>
